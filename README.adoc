...
| image:https://github.com/spring-guides/top-spring-on-kubernetes/actions/workflows/continuous-integration-build.yml/badge.svg[link=https://github.com/spring-guides/top-spring-on-kubernetes/actions/workflows/continuous-integration-build.yml]
